...
ERROR = [ISE_MiL_x,ISE_HiL_x;
 ...
 % Calcular el RMSE en cada instante de tiempo
for i = 1:length(Err_MiL_x)
    % Cálculo del RMSE para el entorno MiL
    RMSE_MiL_x_values(i) = sqrt(mean(Err_MiL_x(1:i).^2));
    RMSE_MiL_y_values(i) = sqrt(mean(Err_MiL_y(1:i).^2));
    RMSE_MiL_z_values(i) = sqrt(mean(Err_MiL_z(1:i).^2));
    RMSE_MiL_w_values(i) = sqrt(mean(Err_MiL_w(1:i).^2));
    
    % Cálculo del RMSE para el entorno HiL
    RMSE_HiL_x_values(i) = sqrt(mean(Err_HiL_x(1:i).^2));
    RMSE_HiL_y_values(i) = sqrt(mean(Err_HiL_y(1:i).^2));
    RMSE_HiL_z_values(i) = sqrt(mean(Err_HiL_z(1:i).^2));
    RMSE_HiL_w_values(i) = sqrt(mean(Err_HiL_w(1:i).^2));
end
...
plot(tiempo, RMSE_MiL_x_values, 'r', 'LineWidth', linewidth_1)
hold on
plot(tiempo, RMSE_HiL_x_values, 'b', 'LineWidth', linewidth_1)
ylabel('$RMSE~\nu_l$', 'Interpreter', 'latex')
...
text(3.6, y_mid, '$ISE~\nu_l $', 'Interpreter', 'latex', 'Rotation', -90, ...
...
plot(tiempo,RMSE_MiL_y_values, 'r', 'LineWidth', linewidth_1)
hold on
plot(tiempo,RMSE_HiL_y_values, 'b', 'LineWidth', linewidth_1)

title('~~~~~~~~~~~~~~~~~~~~~~~(b)', 'Interpreter', 'latex')
ylabel('$RMSE~\nu_m$', 'Interpreter', 'latex')
legend({'$MiL$', '$HiL$'}, 'Interpreter', 'latex')
grid on
...
text(3.6, y_mid, '$ISE~\nu_m$', 'Interpreter', 'latex', 'Rotation', -90, ...
     'HorizontalAlignment', 'center', 'VerticalAlignment', 'middle');
...
plot(tiempo, RMSE_MiL_z_values, 'r', 'LineWidth', linewidth_1)
hold on
plot(tiempo, RMSE_HiL_z_values, 'b', 'LineWidth', linewidth_1)

title('~~~~~~~~~~~~~~~~~~~~~~~(c)', 'Interpreter', 'latex')
ylabel('$RMSE~\nu_n$', 'Interpreter', 'latex')
...
text(3.6, y_mid, '$ISE~\nu_n$', 'Interpreter', 'latex', 'Rotation', -90, ...
     'HorizontalAlignment', 'center', 'VerticalAlignment', 'middle');
...
plot(tiempo,RMSE_MiL_w_values, 'r', 'LineWidth', linewidth_1)
hold on
plot(tiempo,RMSE_HiL_w_values, 'b', 'LineWidth', linewidth_1)
title('~~~~~~~~~~~~~~~~~~~~~~~(d)', 'Interpreter', 'latex')
ylabel('$RMSE~\nu_\omega$', 'Interpreter', 'latex')
legend({'$MiL$', '$HiL$'}, 'Interpreter', 'latex')
grid on
...
text(3.6, y_mid, '$ISE~\nu_\omega$', 'Interpreter', 'latex', 'Rotation', -90, ...
     'HorizontalAlignment', 'center', 'VerticalAlignment', 'middle');
