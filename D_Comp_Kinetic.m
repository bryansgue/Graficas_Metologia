...
axes('Position',[0.05 0.1 .45 .15]);  %axes('Position',[0.05 0.37 .35 .25]);
%% Data generation
% e_pose_plot_Real = line(t_1,norm_e_pose_Real(1,:));
% set(e_pose_plot_Real, 'LineStyle', '-', 'Color', C5, 'LineWidth', 1.1*lw);

e_pose_plot_MiL = line(t_1,h_error_MiL(1,:));
set(e_pose_plot_MiL, 'LineStyle', '-', 'Color', C10, 'LineWidth', 1.1*lw);

e_pose_plot_HiL = line(t_1,h_error_HiL(1,:));
set(e_pose_plot_HiL, 'LineStyle', '-', 'Color', C4, 'LineWidth', 1.1*lw);

e_pose_plot_Real = line(t_1,h_error_Real(1,:));
set(e_pose_plot_Real, 'LineStyle', '-', 'Color', C14, 'LineWidth', 1.1*lw);
...
%% Legend nomeclature
hLegend_3 = legend([e_pose_plot_MiL, e_pose_plot_HiL, e_pose_plot_Real],{'$\|\tilde{\mathbf{\eta}}_{MiL}\|$','$\|\tilde{\mathbf{\eta}}_{HiL}\|$','$\|\tilde{\mathbf{\eta}}\|$'},'fontsize',12,'interpreter','latex','Color',[255 255 255]/255,'Location','best','NumColumns',1,'TextColor','black');
 set(gca,'ticklabelinterpreter','latex',...
         'fontsize',1.3*fontsizeTicks)
%% Figure properties
ax_3 = gca;
...
% xlabel('$\textrm{Time}[s]$','fontsize',10,'interpreter','latex','Color',C18);
% ylabel('$\textrm{Body Velocity Error}[]$','fontsize',10,'interpreter','latex', 'Color',C18);
% 
% %% Legend nomeclature
% hLegend_4 = legend([error_vx_plot,error_vy_plot],{'$\|{\mathbf{\nu}}-{\mathbf{\nu}_{MiL}}\|$','$\|{\mathbf{\nu}}-{\mathbf{\nu}_{HiL}}\|$'},'fontsize',12,'interpreter','latex','Color',[255 255 255]/255,'Location','best','NumColumns',1,'TextColor','black');
%  set(gca,'ticklabelinterpreter','latex',...
%          'fontsize',1.3*fontsizeTicks)
% %% Figure properties
% ax_4 = gca;
